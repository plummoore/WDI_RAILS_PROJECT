...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { category_id_id: @cat.category_id_id, giphy_image: @cat.giphy_image, name: @cat.name } }, as: :json
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { category_id_id: @cat.category_id_id, giphy_image: @cat.giphy_image, name: @cat.name } }, as: :json
    assert_response 200
  end
